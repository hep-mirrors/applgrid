...
namespace nlo {
  ...
  //
  template<class _Jet, typename _Point, 
           typename _Sample = typename _Jet::amp_type::weight_type, 
           template<class _Xp, class _Yp> class _Conv = default_conversion,
           class _Traits = sample_traits<_Sample>,
           class _PointTraits = distpoint_traits<_Point> >
  class basic_user 
    : public virtual basic_user_base<_Jet>
  {
    //   private types
    typedef typename _Jet::amp_type::weight_type _Weight;
  ...
  template<class _Jet, typename _Point, typename _Sample, 
	   template<class _Xp, class _Yp> class _Conv,
	   class _Traits, class _PointTraits>
  _Conv<typename _Jet::amp_type::weight_type, _Sample> 
  basic_user<_Jet, _Point, _Sample, _Conv, _Traits, _PointTraits>::_S_conv;
  
  
  //  Specialization:
  //         Scalar distribution (In this case the _Point = void)
  //
  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp> class _Conv, class _Traits>
  class basic_user<_Jet, void, _Sample, _Conv, _Traits, distpoint_traits<void> >
    : public virtual basic_user_base<_Jet>
  {
    //   private types
    typedef typename _Jet::amp_type::weight_type _Weight;
  ...
  template<class _Jet, typename _Sample, template<class _Xp, class _Yp> class _Conv, class _Traits>
  _Conv<typename _Jet::amp_type::weight_type, _Sample> 
  basic_user<_Jet, void, _Sample, _Conv, _Traits, distpoint_traits<void> >::_S_conv;
  ...
  template<class _Jet, typename _Sample, 
           template<class _Xp, class _Yp> class _Conv,
           class _Traits, class _PointTraits>
  class basic_user<_Jet, double, _Sample, _Conv, _Traits, _PointTraits> 
    : public virtual basic_user_base<_Jet>
  {
    //   private types
    typedef typename _Jet::amp_type::weight_type _Weight;
  ...
  template<class _Jet, typename _Sample, 
	   ...
	   class _Traits, class _PointTraits>
  _Conv<typename _Jet::amp_type::weight_type, _Sample> 
  basic_user<_Jet, double, _Sample, _Conv, _Traits, _PointTraits>::_S_conv;
  

  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp>  class _Conv, 
	   class _Traits, class _PointTraits> 
  void basic_user<_Jet, double, _Sample, _Conv, _Traits, _PointTraits>::
  ...
  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp> class _Conv, 
	   class _Traits, class _PointTraits>
  class basic_user<_Jet, histpoint1d, _Sample, _Conv, _Traits, _PointTraits> 
    : public virtual basic_user_base<_Jet>
  {
    //   private types
    typedef typename _Jet::amp_type::weight_type _Weight;
  ...
  template<class _Jet, typename _Sample,
	   ...
	   class _Traits, class _PointTraits>
  _Conv<typename _Jet::amp_type::weight_type, _Sample> 
  basic_user<_Jet, histpoint1d, _Sample, _Conv, _Traits, _PointTraits>::_S_conv;
  
	
  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp>  class _Conv, 
	   class _Traits, class _PointTraits> 
  void basic_user<_Jet, histpoint1d, _Sample, _Conv, _Traits, _PointTraits>::
  _PhysDirac::accumulate() 
  {
  ...
  template<class _Jet, typename _Sample, 
	   ...
	   class _Traits, class _PointTraits> 
  void basic_user<_Jet, histpoint1d, _Sample, _Conv, _Traits, _PointTraits>::
  phys(int id, const char *name, unsigned int nbin,
       const double *base, double round, double eps) 
  {
    point_type *p = new point_type[nbin];
  ...
  void basic_user<_Jet, histpoint1d, _Sample, _Conv, _Traits, _PointTraits>::
  phys(int id, const char *name, unsigned int nbin, 
       const histpoint1d *base, double eps) 
  {
  ...
  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp> class _Conv, 
	   class _Traits, class _PointTraits>
  class basic_user<_Jet, histpoint2d, _Sample, _Conv, _Traits, _PointTraits>
    : public virtual basic_user_base<_Jet>
  {
    //   private types
    typedef typename _Jet::amp_type::weight_type _Weight;
  ...
  template<class _Jet, typename _Sample,
	   ...
	   class _Traits, class _PointTraits>
  _Conv<typename _Jet::amp_type::weight_type, _Sample> 
  basic_user<_Jet, histpoint2d, _Sample, _Conv, _Traits, _PointTraits>::_S_conv;
  
  
  template<class _Jet, typename _Sample, 
	   template<class _Xp, class _Yp>  class _Conv, 
	   class _Traits, class _PointTraits> 
  void basic_user<_Jet, histpoint2d, _Sample, _Conv, _Traits, _PointTraits>::
  phys(int id, const char *name,
  ...
  void basic_user<_Jet, histpoint2d, _Sample, _Conv, _Traits, _PointTraits>::
  phys(int id, const char *name,
       unsigned int nx, const double *xbase, double rx, 
       unsigned int ny, const double *ybase, double ry) 
  {
    point_type *p = new point_type[nx*ny];
    unsigned int idx;
