...
!!$  integer, parameter :: vogt_imod_e     = -2
!!$  integer, parameter :: vogt_imod_p     = -1
!!$  integer, parameter :: vogt_imod_nav   =  0
!!$  integer, parameter :: vogt_imod_nerr1 =  1
!!$  integer, parameter :: vogt_imod_nerr2 =  2
!!$  integer, parameter :: vogt_imod_def = vogt_imod_p
!!$  integer, public    :: vogt_imod = vogt_imod_def

  !--- is it useful to have a fake upper entry?
  ! put charm quark mass just above sqrt(2)
  real(dp), public :: quark_masses(6) = (/1e-10_dp,1e-10_dp,0.15_dp,&
...
!!$  integer, parameter, public :: factscheme_default = factscheme_MSbar
!!$  integer, parameter, public :: factscheme_Poldefault = factscheme_PolMSbar
