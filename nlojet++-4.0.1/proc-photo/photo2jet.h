...
#ifndef __NLO_PHOTO2JET_H__
#define __NLO_PHOTO2JET_H__ 1
...
namespace nlo {
  ...
  public:
    //   constructor
    explicit photo2jet(const random_generator&, bool=false, unsigned int=2, unsigned int=3, double=1.0);
  ...
  private:
    ...
    //   Dipole contributions
    typedef void (photo2jet::*dipole_func)(int, int, weight_type&);
