...
#ifndef __NLO_DIS3JET_H__
#define __NLO_DIS3JET_H__ 1
...
namespace nlo {
  ...
  public:
    //   constructor
    explicit dis3jet(const random_generator&, bool=false, unsigned int=2, unsigned int=3, double=1.0);
  ...
  private:
    ...
    //       dipole contributions
    typedef void (dis3jet::*dipole_func)(int, int, weight_type&);
