...
#ifndef __NLO_PSG_PHASESPACE_N0I0F0_H__
#define __NLO_PSG_PHASESPACE_N0I0F0_H__ 1
...
namespace nlo {
  ...
  template<>
  class basic_phasespace<hadronic_event<lorentzvector<double>, hadronic_event_traits<0U,0U,0U> > >
    : public phasespace<hadronic_event<lorentzvector<double>, hadronic_event_traits<0U,0U,0U> > >
  {
    //  private types
    //   abstract base type
    typedef phasespace<hadronic_event<lorentzvector<double>, hadronic_event_traits<0U,0U,0U> > > _Base;
  ...
  public:
    ...
    basic_phasespace(const random_generator *rng, double s,
      ...
      : _Base(rng), _M_s(s), _M_beta(beta), _M_eps(eps), _M_intpsgen(true),
	_M_psgen(new _Rambo(rng)) {}
